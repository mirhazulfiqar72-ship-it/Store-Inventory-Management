...
if _footer_marker in app and 'c.drawCentredString(W/2,13,"Made by Zulfiqar Ali")' not in app:
    app = app.replace(
        _footer_marker,
        '        c.drawString(24,13,REPORT_FOOTER)\n'
        '        c.drawCentredString(W/2,13,"Made by Zulfiqar Ali")\n'
        '        c.drawRightString(W-24,13,f"Page {page_no}")\n',
        1,
    )
elif 'c.drawCentredString(W/2,13,"Made by Zulfiqar Ali")' not in app:
    raise RuntimeError("Could not locate report footer for author-credit patch.")
